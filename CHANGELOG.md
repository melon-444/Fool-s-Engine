...
- **JavaDoc** — 添加 JavaDoc 注释到源文件
- **Cursor mode** — 将光标模式管理职责从 InputDevice 移至 Window

- **JavaDoc** — added JavaDoc comments to source files
- **Cursor mode** — moved cursor mode responsibility from InputDevice to Window

---

## 0.0.1 — 2026-06-03

- 初始预览版本 / Initial preview release
